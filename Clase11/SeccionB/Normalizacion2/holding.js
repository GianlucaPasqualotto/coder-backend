...
const normalizeData = normalize(holding,holdingSchema);
// console.log(JSON.stringify(normalizeData, null, "\t"));
console.log(JSON.stringify(normalizeData, null, "\t").length);

const normalData = denormalize(normalizeData.result,holdingSchema,normalizeData.entities);
// console.log(JSON.stringify(normalizeData, null, "\t"));
console.log(JSON.stringify(normalData, null, "\t").length);